---
name: XDON Output (Compact)
description: Token-efficient structured response format with 20-35% savings vs JSON
type: skill
tags: [xdon, token-efficiency, structured-data]
---

# XDON Output (Compact)

Output XDON format (eXtensible Compact Object Notation) — schema-ambient compact data, 30–40% smaller than JSON in text and up to 72% smaller in BXDON binary.
